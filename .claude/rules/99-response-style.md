---
description: How to respond when generating code for PulseIQ
---
...
- When adding a new module, place it in the correct architectural layer and name it clearly.
...
- Start development unless explicitly asked to implement.
